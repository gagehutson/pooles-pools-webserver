...
<div id="id01" class="modal">
      <form class="modal-content animate" action="login.php" method="post">
        ...
        <div class="container">
        <h1 class="modaltitle">Login Or Create Account </br> Before Placing an Order</h1>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white container-fluid" id="gtco-main-nav">
  ...
  <div class="container mt-5">
    <h2 class="text-center mb-4" style="padding-bottom: 40px;">Shopping Cart</h2>

<?php if (!empty($_SESSION['cart'])): ?>
  <table class="table table-bordered">
  <thead style="background-color: rgb(146, 184, 228);">
  <tr>
    <th style="border-top-left-radius: 15px;">Item</th>
    <th>Quantity</th>
    <th>Price</th>
    <th>Total</th>
  ...
  <div class="text-right">
    ...
    <a href="checkout.php" style="background-color: #4989d3; border-color: #4989d3;" class="btn btn-success btn-lg mt-3">Proceed to Checkout</a>
  </div>
...
<?php unset($_SESSION['show_login_modal']); endif; ?>
